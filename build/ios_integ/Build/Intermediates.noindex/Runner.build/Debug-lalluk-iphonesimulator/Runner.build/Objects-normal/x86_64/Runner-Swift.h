...
SWIFT_CLASS("_TtC6Runner22FLNativeDatePickerView")
@interface FLNativeDatePickerView : NSObject <FlutterPlatformView>
...
SWIFT_CLASS("_TtC6Runner29FLNativeDatePickerViewFactory")
@interface FLNativeDatePickerViewFactory : NSObject <FlutterPlatformViewFactory>
...
SWIFT_CLASS("_TtC6Runner18FLNativePickerView")
@interface FLNativePickerView : NSObject <FlutterPlatformView>
- (UIView * _Nonnull)view SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC6Runner25FLNativePickerViewFactory")
@interface FLNativePickerViewFactory : NSObject <FlutterPlatformViewFactory>
- (id <FlutterPlatformView> _Nonnull)createWithFrame:(CGRect)frame viewIdentifier:(int64_t)viewId arguments:(id _Nullable)args SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
