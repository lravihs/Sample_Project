...
SWIFT_CLASS("_TtC6patrol22PatrolAppServiceClient")
@interface PatrolAppServiceClient : NSObject
/// Construct client for accessing PatrolAppService server using the existing channel.
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)listDartTestsWithCompletionHandler:(void (^ _Nonnull)(NSArray<NSString *> * _Nullable, NSError * _Nullable))completionHandler;
- (void)runDartTestWithName:(NSString * _Nonnull)name completionHandler:(void (^ _Nonnull)(RunDartTestResponse * _Nullable, NSError * _Nullable))completionHandler;
@end
...
SWIFT_CLASS("_TtC6patrol19RunDartTestResponse")
@interface RunDartTestResponse : NSObject
