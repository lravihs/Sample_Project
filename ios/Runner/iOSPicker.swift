...
class FLNativePickerViewFactory: NSObject, FlutterPlatformViewFactory {
...
class FLNativePickerView: NSObject, FlutterPlatformView {
    ...
    func createNativeView(view _view: UIView) {
        ...
        let channel = FlutterMethodChannel(name: "ListPicker/swift_native",
        ...
        date_picker.accessibilityIdentifier = "iOSPicker"
